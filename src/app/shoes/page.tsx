...
const Shoes = () => {
  const shoesData = [
    ...
    {id: '3', name: 'Nike Rollred', description: 'Loin Shoes', price: 400, image: '/images (14).jpeg'},
    {id: '4', name: 'Nike Sprender Air', description: 'Jence Shoes', price: 250, image: '/images (6).jpeg'},
      ...
      <div className='shoes'>
        {shoesData.map((shoe) => (
          <div key={shoe.id} className='shoes-card'>
            <Image src={shoe.image} alt={shoe.name} width={200} height={180} />
